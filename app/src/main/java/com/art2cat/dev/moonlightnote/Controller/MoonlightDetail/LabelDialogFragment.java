...
public class LabelDialogFragment extends DialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        label_TIET = (TextInputEditText) view.findViewById(R.id.dialog_edittext);
        label_TIET.setHint(R.string.dialog_enter_new_label);
                ...
                .setPositiveButton("OK",
                        new DialogInterface.OnClickListener()
                        {
                            ...
                            public void onClick(DialogInterface dialog, int id)
                            {
                                ...
                                busEvent.setFlag(Constants.BUS_FLAG_LABEL);
                                busEvent.setMessage(label);
