...
public class SetNicknameFragment extends DialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        View view = inflater.inflate(R.layout.dialog_set_nickname, null);
        final TextInputEditText nicknameTIET = (TextInputEditText) view.findViewById(R.id.dialog_set_nickname);
