...
/**
 * Created by huang.yiming on 6/28/2017.
 */
...
public class MoonlightEncryptTest {
  ...
  public void testEncrypt() {
    ...
    Moonlight encrypt = MoonlightEncryptUtils.encryptMoonlight(key, moonlight);
    Assert.assertNotNull(encrypt);
    System.out.println(encrypt.getContent());

    Moonlight decrypt = MoonlightEncryptUtils.decryptMoonlight(key, encrypt);
